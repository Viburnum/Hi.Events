...
use HiEvents\Http\Actions\Attendees\Public\DownloadAppleWalletPassPublicAction;
use HiEvents\Http\Actions\Attendees\Public\GetGoogleWalletPassPublicAction;
...
use HiEvents\Http\Actions\Common\Webhooks\PayPalIncomingWebhookAction;
...
use HiEvents\Http\Actions\Orders\Payment\PayPal\CapturePayPalOrderActionPublic;
use HiEvents\Http\Actions\Orders\Payment\PayPal\CreatePayPalOrderActionPublic;
...
$router->prefix('/public')->group(
    function (Router $router): void {
        ...
        $router->get('/events/{event_id}/attendees/{attendee_short_id}/apple-wallet-pass', DownloadAppleWalletPassPublicAction::class);
        $router->get('/events/{event_id}/attendees/{attendee_short_id}/google-wallet-pass', GetGoogleWalletPassPublicAction::class);
        ...
        $router->post('/events/{event_id}/order/{order_short_id}/paypal/order', CreatePayPalOrderActionPublic::class);
        $router->post('/events/{event_id}/order/{order_short_id}/paypal/order/{paypal_order_id}/capture', CapturePayPalOrderActionPublic::class);
        ...
        $router->post('/webhooks/paypal', PayPalIncomingWebhookAction::class);
