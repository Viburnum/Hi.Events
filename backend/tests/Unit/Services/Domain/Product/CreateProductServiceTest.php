...
class CreateProductServiceTest extends TestCase
{
    ...
    public function test_persist_product_includes_hard_ticket_fields(): void
    {
        ...
        $productAddonAssociationService = app(ProductAddonAssociationService::class);
        ...
        $service = new CreateProductService(
            ...
            $productAddonAssociationService,
            $priceCreateService,
            $purifier,
            $eventRepository,
